...
<h3>電商藥妝：購物車</h3>
<a href="index.php" class="btn btn-primary" id="btn01" name="btn01">繼續購物</a>
<button type="button" class="btn btn-secondary" id="btn02" name="btn02" onclick="window.history.go(-1)">回上一頁</button>
...
<a href="checkout.php" class="btn btn-danger">前往結帳</a>
